...
<body>
    <div class="main">
        ...
        <div class="reset p-xl-0 p-lg-0 p-md-0 p-sm-4 p-4">
                ...
                <div id="resetform">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="form-group">
                                <input id="email" placeholder="Διεύθυνση email" class="form-control form-control-lg" type="email">
                                <div class="text-danger text-left"></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <button class="btn btn-lg btn-primary btn-block" type="button" id="reset">Συνέχεια</button>
